...
ides an approach similar to high throughput chemical filtering in the pharmaceuticals domain. It is implemented using fully open-source technology stack using Streamlit.')